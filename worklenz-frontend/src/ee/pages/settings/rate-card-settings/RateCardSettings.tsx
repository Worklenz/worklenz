...
import RateCardDrawer from '@/ee/components/projects/project-finance/rate-card-drawer/RateCardDrawer';
        ...
        title={
          <Flex justify="flex-end" align="center" gap={8}>
            <Input
              ...
              placeholder={t('searchPlaceholder', { defaultValue: 'Search rate cards by name' })}
              style={{ maxWidth: 232 }}
