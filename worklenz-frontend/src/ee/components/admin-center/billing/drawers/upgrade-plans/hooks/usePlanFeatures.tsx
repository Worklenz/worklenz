...
export function usePlanFeatures(
  ...
  const generateBusinessPlanFeatures = () => {
      ...
      return [
        ...
        <PlanFeature
          ...
          text={t(
            ...
            'Up to 50 Users Max (AppSumo Special)'
          )}
        />,
        <PlanFeature
          key="2"
          text={t(
            'appSumoAdditionalUsers',
            'Additional users beyond included: $5.99/user/month'
          )}
        />,
        <PlanFeature
          key="3"
          text={t(
            'appSumoScheduleClientFinance',
            'Get full access to Schedule, Client Portal and Finance'
          )}
        />,
        <PlanFeature key="4" text={t('appSumoCustomColumns', 'Unlimited custom columns')} />,
        <PlanFeature
          key="5"
          text={t('appSumoFileHandling', 'Large file handling as attachments')}
        />,
        <PlanFeature key="6" text={t('appSumoChatHistory', 'Long chat history')} />,
      ];
    }
    ...
    return [
      ...
      <PlanFeature
        key="2"
        text={t('pricing-modal:plans.business.maxUsers', 'Up to {{count}} Users Max', {
          count: (() => {
            const maxStr =
