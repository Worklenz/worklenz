'use strict';
// Converted from database/migrations/20260222000000-fix-task-activity-logs-cascade-delete.sql
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'task_activity_logs_tasks_id_fk') THEN
    ALTER TABLE task_activity_logs ADD CONSTRAINT task_activity_logs_tasks_id_fk FOREIGN KEY (task_id) REFERENCES tasks(id) 
    ON DELETE SET NULL;
  END IF;
END $$;
