'use strict';
// Converted from: database/migrations/add-role-name-to-session.sql
...
exports.up = async (pgm) => {
  pgm.sql(`
-- Migration: Add role_name to user session
-- Description: Updates deserialize_user function to include role_name for team lead checks
-- Date: 2025-01-XX
