...
exports.down = pgm => {
  pgm.sql('DROP TRIGGER IF EXISTS ensure_parent_task_without_manual_progress_trigger ON tasks;');
  pgm.sql('DROP FUNCTION IF EXISTS ensure_parent_task_without_manual_progress();');
