...
exports.up = pgm => {
  ...
  pgm.sql(`
    ...
    ON tasks (project_id, status_sort_order)
  `);
  
  pgm.sql(`
    CREATE INDEX IF NOT EXISTS idx_tasks_priority_sort_order 
    ON tasks (project_id, priority_sort_order)
  `);
  
  pgm.sql(`
    CREATE INDEX IF NOT EXISTS idx_tasks_phase_sort_order 
    ON tasks (project_id, phase_sort_order)
  `);
