'use strict';
// Converted from: database/migrations/release-v2.2.1-business-plan-trial/003_update_deserialize_user_for_plan_trials.sql
...
exports.up = async (pgm) => {
  pgm.sql(`
-- Migration: Update deserialize_user function to include plan trial data
-- Description: Modifies deserialize_user to return plan trial information for feature access
-- Date: 2025-01-18
...
BEGIN
    ...
    plan_trial_data AS (
        ...
        LEFT JOIN licensing_plan_trials pt ON pt.user_id = tod.id
...
COMMENT ON FUNCTION deserialize_user IS 'Returns user session data including plan trial information for feature access control';
  `);
};
