...
exports.down = pgm => {
  pgm.sql('DROP FUNCTION IF EXISTS handle_task_list_sort_order_change(json);');
  pgm.sql('DROP FUNCTION IF EXISTS update_task_sort_orders_bulk(json, text);');
  pgm.sql('DROP FUNCTION IF EXISTS get_sort_column_name(TEXT);');
};
