...
ALTER TABLE licensing_plan_tiers
    ADD CONSTRAINT licensing_plan_tiers_pk
        PRIMARY KEY (id);

ALTER TABLE licensing_plan_tiers
    ADD CONSTRAINT licensing_plan_tiers_tier_name_unique
        UNIQUE (tier_name);

ALTER TABLE licensing_plan_tiers
    ADD CONSTRAINT licensing_plan_tiers_pricing_model_check
...
ALTER TABLE public.licensing_pricing_plans
    ADD CONSTRAINT licensing_pricing_plans_licensing_plan_tiers_id_fk
