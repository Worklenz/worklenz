...
-- 1. Create table for template custom columns
...
-- 2. Create table for column configurations
...
-- 3. Create table for selection options (dropdown/select columns)
...
-- 4. Create table for label options (label columns)
