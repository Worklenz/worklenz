...
CREATE INDEX idx_task_comments_task ON client_portal_task_comments(task_id);
CREATE INDEX idx_task_comments_org ON client_portal_task_comments(organization_team_id);
CREATE INDEX idx_task_comments_project ON client_portal_task_comments(project_id);
CREATE INDEX idx_task_comments_created_at ON client_portal_task_comments(created_at);
