...
CREATE INDEX idx_comment_reactions_comment_id ON project_comment_reactions(comment_id);
CREATE INDEX idx_comment_reactions_user_id ON project_comment_reactions(user_id);
...
CREATE INDEX idx_comment_edit_history_comment_id ON project_comment_edit_history(comment_id);
CREATE INDEX idx_comment_edit_history_edited_at ON project_comment_edit_history(edited_at DESC);
