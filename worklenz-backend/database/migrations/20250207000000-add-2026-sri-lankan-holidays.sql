-- ================================================================
-- Backfill Migration: Add 2026 Sri Lankan Holidays
-- ================================================================
-- This migration adds 2026 Sri Lankan holidays for databases that
-- already executed the initial migration before 2026 data was added.
--
-- PURPOSE:
-- The original migration (20250131000000-sri-lankan-holidays.sql) was
-- modified to include 2026 data. However, databases that executed the
-- migration before this modification will not have received the 2026 data.
-- This migration backfills that data for those databases.
--
-- IDEMPOTENT: Uses ON CONFLICT DO NOTHING to safely run on all databases
-- ================================================================
