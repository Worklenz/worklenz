...
import verifyTaskAccess, {verifyTaskAccessViaComment, verifyNonGuestTaskAccess} from "../../middlewares/verify-task-access";
...
taskCommentsApiRouter.delete("/attachment/:id/:taskId", idParamValidator, verifyNonGuestTaskAccess('params', 'taskId'), safeControllerFunction(TaskCommentsController.deleteAttachmentById));
