...
class ClientPortalController {
  ...
  static async createRequest(
    ...
    try {
      ...
      // Create request - req_no will be auto-generated by database trigger
      const insertQuery = `
        INSERT INTO client_portal_requests (
          service_id, client_id, organization_team_id,
  ...
  private static generateWelcomeEmailHTML(data: {
    ...
    const darkerColor = this.hexToRgb(primaryColor) 
      ? this.adjustBrightness(primaryColor, -20)
      : "#389e0d";
